...
batch_root = repo_root.join("experiments/protocols/implementation-track-runs/F1-phase-field-cpp-r2")
...
shared_options = {
  ...
  case_manifest_ref: "experiments/protocols/case_manifests/F1-phase-field-cpp-r2.yaml",
...
comparison_summary = {
  "batch_id" => "F1-phase-field-cpp-r2",
  "generated_at" => Time.now.utc.iso8601,
  "scope" => "phase-field implementation reacquisition batch",
  "comparison_modes" => [
    {
      "review_mode" => "single_review",
  ...
  "caveats" => [
    "This batch is a reacquisition of the original phase-field implementation snapshot, not a revised implementation cycle.",
    "Intent Track and Spec Track are not part of this batch; use F1 upstream manifests for those tracks."
  ]
}
  ...
  YAML.dump(
    {
      ...
      "run_labels" => [
        "F1-phase-field-cpp-r2-single",
        "F1-phase-field-cpp-r2-dual-only",
        "F1-phase-field-cpp-r2-dual"
      ]
    }
  )
)
