...
batch_id = "F1-spec-phase-field-reverse-spec-narrative"
batch_root = repo_root.join("experiments/protocols/spec-track-runs", batch_id)
...
single_writer = DualReviewer::TrackRuns::SpecTrackWriter.new(
  **shared_options,
  run_label: "F1-spec-phase-field-reverse-spec-narrative-single",
...
comparison_summary = {
  ...
  "scope" => "phase-field reverse-spec narrative batch",
  "comparison_modes" => [
    {
      "review_mode" => "single_review",
      "run_label" => "F1-spec-phase-field-reverse-spec-narrative-single",
  ...
  "caveats" => [
    ...
    "Spec-track outputs remain refinement evidence; they do not by themselves validate behavioral adequacy or implementation correctness."
  ]
}
