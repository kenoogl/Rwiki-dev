...
- 節 1 レビュー基本規律：全レビュー段階で適用（検出 / 提示 / 判定 / 記録の 4 段階）
- 節 2：要件レビューの 5 ラウンド構成と波及精査
- 節 3：設計レビューの 10 観点と進め方
- 節 4：フェーズ完走後のフィーチャー横断レビューパターン
- 節 5：タスクレビューの 7 観点と進め方

HUMAN_WORKFLOW.md 5.2.8〜5.2.11 のプレースホルダは本書の 節 2〜5 へ 2 段リンクで対応する（基本規律 ＝ 節 1）。
