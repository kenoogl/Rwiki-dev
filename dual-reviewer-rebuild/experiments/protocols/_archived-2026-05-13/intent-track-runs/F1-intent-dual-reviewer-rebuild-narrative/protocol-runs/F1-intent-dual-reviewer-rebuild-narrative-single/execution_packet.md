...
5. `phase_metric_snapshot.json` と `signal_linkage_note.yaml` を更新する
  ...
  - `experiments/protocols/intent-track-runs/F1-intent-dual-reviewer-rebuild-narrative/protocol-runs/F1-intent-dual-reviewer-rebuild-narrative-single/intent_review.md`
  - `experiments/protocols/intent-track-runs/F1-intent-dual-reviewer-rebuild-narrative/protocol-runs/F1-intent-dual-reviewer-rebuild-narrative-single/intent_trace_note.yaml`
  - `experiments/protocols/intent-track-runs/F1-intent-dual-reviewer-rebuild-narrative/protocol-runs/F1-intent-dual-reviewer-rebuild-narrative-single/phase_metric_snapshot.json`
  - `experiments/protocols/intent-track-runs/F1-intent-dual-reviewer-rebuild-narrative/protocol-runs/F1-intent-dual-reviewer-rebuild-narrative-single/signal_linkage_note.yaml`
