...
1. design を読み、phase-local issue / ambiguity / ordering issue を抽出する
...
4. `phase_metric_snapshot.json` と `signal_linkage_note.yaml` を更新する
  ...
  - `experiments/protocols/spec-track-runs/F1-design-phase-field-reverse-spec/protocol-runs/F1-design-phase-field-single/reviewed_phase_note.md`
  - `experiments/protocols/spec-track-runs/F1-design-phase-field-reverse-spec/protocol-runs/F1-design-phase-field-single/alignment_artifact.yaml`
  - `experiments/protocols/spec-track-runs/F1-design-phase-field-reverse-spec/protocol-runs/F1-design-phase-field-single/phase_metric_snapshot.json`
  - `experiments/protocols/spec-track-runs/F1-design-phase-field-reverse-spec/protocol-runs/F1-design-phase-field-single/signal_linkage_note.yaml`
