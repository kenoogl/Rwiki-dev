  ...
  - run label: `F1-spec-phase-field-reverse-spec-narrative-single`
...
4. `phase_metric_snapshot.json` と `signal_linkage_note.yaml` を更新する
  ...
  - `experiments/protocols/spec-track-runs/F1-spec-phase-field-reverse-spec-narrative/protocol-runs/F1-spec-phase-field-reverse-spec-narrative-single/reviewed_phase_note.md`
  - `experiments/protocols/spec-track-runs/F1-spec-phase-field-reverse-spec-narrative/protocol-runs/F1-spec-phase-field-reverse-spec-narrative-single/alignment_artifact.yaml`
  - `experiments/protocols/spec-track-runs/F1-spec-phase-field-reverse-spec-narrative/protocol-runs/F1-spec-phase-field-reverse-spec-narrative-single/phase_metric_snapshot.json`
  - `experiments/protocols/spec-track-runs/F1-spec-phase-field-reverse-spec-narrative/protocol-runs/F1-spec-phase-field-reverse-spec-narrative-single/signal_linkage_note.yaml`
