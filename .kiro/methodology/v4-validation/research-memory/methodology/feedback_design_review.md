...
- v3 (= adversarial subagent 統合): `feedback_design_review_v3_generalization_design.md` (Phase A 全体設計 + Layer 1/2/3 三層構造)
- v4 (= judgment subagent + necessity 5-field): `feedback_review_v4_necessity_judgment.md` + `feedback_v4_design_phase_3spec_completion.md`
...
- 深掘り検討 + 自動採択方針 (feedback_deepdive_autoadopt.md): 設計でも継承、致命的デメリットなしなら自動採択
...
- feedback_deepdive_autoadopt.md / feedback_dominant_dominated_options.md / feedback_choice_presentation.md / feedback_approval_required.md — 仕様 / 設計両フェーズで継承
