...
description: 過去レビューログ (docs/Rwiki-V2-dev-log-1.md / 2.md / 3.md) から抽出したユーザーの escalate 判定パターン 23 種。Step 1b-iii で各ラウンドごとに通読しチェック、該当箇所が見つかれば escalate 候補。LLM の自動採択偏向を回避する実例ベース校正リスト。
type: feedback
