...
_change log_
- 2026-04-20: severity-unification spec により severity 4 水準(CRITICAL/ERROR/WARN/INFO) / status 2 値(PASS/FAIL) / exit code 3 値分離(0=PASS, 1=runtime error, 2=FAIL)に整合。map_severity() 廃止、sub_severity タプル廃止、AGENTS/audit.md の HIGH/MEDIUM/LOW → ERROR/WARN/INFO rename。
