...
- [x] 3.2 (P) query_extract.md を templates/AGENTS/ に作成する
  ...
  - Output セクションに出力契約（`review/query/<query_id>/` 配下の4ファイル: `question.md`, `answer.md`, `evidence.md`, `metadata.json`）を明記する（cli-query スペックの前提条件）
...
- [x] 3.5 (P) audit.md を templates/AGENTS/ に作成する
  ...
  - 全3ポリシー（`page_policy.md`, `naming.md`, `git_ops.md`）との整合性を確認する
...
- [x] 5. AGENTS/README.md の作成
  ...
  - 全3ポリシーの一覧と位置づけ（タスクエージェントとの違い）を記載する
...
- [x] 8. CHANGELOG.md への agents-system エントリ追記
  ...
  - 成果物として、9エージェントファイル・3ポリシー・CLAUDE.md更新・AGENTS/README.md・docs/user-guide.md を列挙する
